        ...
        home: Scaffold(
          ...
          body: SafeArea(
            child: Column(children:[
               ...
               Image(
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text('Box',
                          style: TextStyle(fontSize:24, fontFamily: 'Rubik Medium', color: Color(0xffF9703B) )
                      ),
                    ],
                  ),
              ...
              const SizedBox(height: 14),
              const Center(
                  child: Text('Here we are to help you!\nJust be with us!', textAlign: TextAlign.center,
